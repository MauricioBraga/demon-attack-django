...
function onKeyDown(e: KeyboardEvent) {
    // Evita que espaço/setas rolem a página ou ativem um botão que porventura
    // esteja com foco, já que essas teclas são tratadas como comandos do jogo.
    // Atalhos com Ctrl/Alt/Meta (recarregar, devtools, etc.) não são afetados.
